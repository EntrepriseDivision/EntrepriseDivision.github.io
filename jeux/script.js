...
var affiche = document.getElementById("divAffiche1");
 ...
 var operation1 = "";
    ...
    if (message2 == "Bonne réponse") {
        var message3 =  "<div id='bonneRep'><strong>" + message2 + "<br>  Votre pointage est " + messagePoint + ".</strong> </div>"
            affiche2.innerHTML=message3; 
    } else if (message2 == "Mauvaise réponse") {
      var message3 = "<div id='mauvRep'><strong>" + message2 + "<br> Votre pointage est " + messagePoint + ". </strong></div>"
      affiche2.innerHTML=message3;
    }
