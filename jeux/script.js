    ...
    var q1operation1 = "";
      ...
      q1affiche2.innerHTML=q1message3;
       ...
       // Remplace le boite de imput avec les imput de la deuxième question. 
        q1affiche.innerHTML = "<div id='titreq1'>Question 2:</div>" + "<div class='radcss'>" + "<input type='number' id='num1Q2' name='num1Q2' placeholder='Nombre 1' /> <br> <input type='number' id='num2Q2' name='num2Q2' placeholder='Nombre 2' /> <br>  <input type='number' id='num3Q2' name='num3Q2' placeholder='Nombre 3'> <br></div> <input type='button' id='btnQ2'  name='btnQ2' onclick='q2calcule()' value='Soumettre!'/>";
    }
...
//Creation de fonction q2calcule2() qui initialise les variables pour ensuite calculer une equation qui utilise les trois nombres choisis par l'utilisateur. //
 var messagePoint1 = messagePoint1; 
    function q2calcule() {
      ...
      var q1affiche2 = document.getElementById("q1divAffiche2");
      q1affiche2.innerHTML= " <div class='radcss'><input id='rad1' name='rad1' type='radio' value='+' /> <label for='rad1'>+</label> <br> <input id='rad2' name='rad1' type='radio' value='-' /> <label for='rad2'>-</label> <br> <input id='rad3' name='rad1' type='radio' value='*' /> <label for='rad3'>x</label> <br><input id='rad4' name='rad1' type='radio' value='/' /><label for='rad4'>/</label></div> <br> <br> <input type='button' id='btn2Q2' onclick='q2calcule2()' value='Soumettre votre réponse'/>" 
  ...
  messagePoint1+=1;
   ...
   messagePoint1+=1;
    ...
    //Ajoute pas un point au compteur
      ...
      var q1affiche2 = document.getElementById("q1divAffiche2");
        if (q1message2 == "Bonne réponse") {
         var q2message3 =  "<div id='q2bonneRep'><strong>" + q1message2 + "<br>  Vous avez gagnez un point </div> <br> <br>" + "<input type='button' name='pointage' id='affichepoint' value='Affiche Pointage!' onclick='point()'/> </strong>"
            q1affiche2.innerHTML=q2message3; 

        // Affiche le text de mauvais reponse et ajoute le boutton pour afficher le score 
      } else if (q1message2 == "Mauvaise réponse") {
        var q2message3 = "<div id='q2mauvRep'><strong>" + q1message2 + "<br> Votre pointage n'a pas changer </div> <br> <br>"  + "<input type='button' name='pointage' id='affichepoint' value='Affiche Pointage!' onclick='point()'/> </strong>"
        q1affiche2.innerHTML=q2message3;
       } 
      }
    }
    ...
    function point() {
     //Affiche le score final du jeu 
      var q1affiche2 = document.getElementById("q1divAffiche2");
      var q2message3 =  "Le pointage final est:  " + messagePoint1 + " <br> <br> Merci de jouer notre jeu! A la prochain." 
      q1affiche2.innerHTML=q2message3;
